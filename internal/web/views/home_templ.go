...
func Home(user *domain.User, featured []domain.CourseSummary) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "   <script>document.documentElement.classList.add(\"js\")</script> <section class=\"py-14 text-center sm:py-20\"><p class=\"reveal font-mono text-sm text-emerald-600 dark:text-emerald-400\">$ man duck <span class=\"tui-cursor\" aria-hidden=\"true\">▊</span></p><h1 class=\"reveal mx-auto mt-6 max-w-4xl text-4xl font-bold tracking-tight sm:text-6xl\" style=\"--reveal-delay:.08s\">Software isn't magic.<br><span class=\"text-emerald-600 dark:text-emerald-400\">Build it and see.</span></h1><p class=\"reveal mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-400\" style=\"--reveal-delay:.16s\">Rubber Duck courses make you build the things you use every day — hash maps, databases, terminals, whole operating systems — in real code, graded by real test suites.</p><div class=\"reveal mt-8 flex flex-wrap items-center justify-center gap-3\" style=\"--reveal-delay:.24s\">")
			if templ_7745c5c3_Err != nil {
